...
if (isset($_REQUEST['id']) and !empty($_REQUEST['id']))
{
	   ...
	   $required_height=isset($_REQUEST['w']) ? $_REQUEST['h'] : '';
		...
		//echo "      ".DB_SERVER,DB_SERVER_USERNAME,DB_SERVER_PASSWORD,DB_DATABASE;
			  ...
			  {			  
					...
					switch ($subcmd)
					{
							...
							case 'results_zoom':
							{
									...
									$_REQUEST['w'] = isset($_REQUEST['w']) ? intval($_REQUEST['w']) : 82;
									$_REQUEST['h'] = isset($_REQUEST['h']) ? intval($_REQUEST['h']) : 115;
									break;
							}
							case 'resultsgallery':
							{
