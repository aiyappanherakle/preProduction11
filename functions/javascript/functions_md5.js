...
function md5()
{
    if (navigator.userAgent.indexOf("Mozilla/") == 0 && parseInt(navigator.appVersion) >= 4)
    {
        var md5string = hex_md5(str_to_ent(trim($("input[name=password]").val())));
        $("input[name=md5pass]").val(md5string);
        if ($("input[name=md5pass_utf]"))
        {
            md5string = hex_md5(trim($("input[name=password]").val()));
            $("input[name=md5pass_utf]").val(md5string);
        }
        $("input[name=hpwd]").val($("input[name=password]").val());
...
/*======================================================================*\
|| ####################################################################
|| # CVS: $RCSfile: functions_md5.js,v $ - $Revision: 1.00 $
|| ####################################################################
\*======================================================================*/