...
var iframe_image_background = "<body background=\"" + wysiwyg_path + "/iframe_background.gif\" style=\"background-attachment: fixed; background-repeat: repeat;\">";

var show_custom_bbcode_bar = 0;
var array_toolbar_user_custom = new Array();

var toolbar1 = 'btRemove_Format,SPACE,btFont_Name,SPACE,btFont_Size,SPACE,btFont_Color,SPACE,btUndo,btRedo,btDeleteAll';
...
var textarea_toolbar1 = 'btRemove_Format,SPACE,btFont_Name,SPACE,btFont_Size,SPACE,btFont_Color,SPACE,btUndo,btRedo,btDeleteAll';
...
function print_wysiwyg_editor(a, b, c, d, e, f, g)
{
    ...
    if (is_rich_text)
    {
        ...
        allRTEs += b;
        editor_cookie = read_cookie("bbeditor_cookie");
    ...
    write_wysiwyg_editor(a, b, c, d, e, f, g);
}
...
function prepare_bbeditor_wysiwygs()
{
    var a = allRTEs.split(";");
    for (var i = 0; i < a.length; i++)
    {
        update_bbeditor_wysiwyg(a[i])
    }
}

function update_bbeditor_wysiwyg(a)
{
    starup = 0;
    if (isKonqueror || isICab || isIE_Mac || view_richtext == '0')
    {
        document.getElementById('bbeditor_bbcode_ouput_' + a).value = document.getElementById("textarea_" + a).value;
        document.getElementById('bbeditor_html_ouput_' + a).value = parse_bbcode_to_html(document.getElementById("textarea_" + a).value)
    }
...
function switch_editor(a)
{
    ...
    currenteditor = a;
    if (editor_type == '1')
    { // switch from wysiwyg to bbcode text mode
        editor_type = '0';
        ...
        create_cookie('bbeditor_cookie', '0', 365);
        c = parse_html_to_bbcode(c);
    ...
    { // rebuild wysiwyg toolbar
        if (isMacOS && isGecko)
        {
            ...
            document.getElementById(a).style.width = '595px';
        ...
        create_cookie('bbeditor_cookie', '1', 365);
...
function write_wysiwyg_editor(a, b, c, d, e, f, g)
{
    document.write('<table cellpadding="0" cellspacing="0" border="0">');
    document.write('<tr>');
    document.write('<td class="wysiwyg_wrapper" colspan="3">');
    
    if (is_rich_text)
    {
        document.write('<div id="bbeditor_richtool' + b + '">');
        ...
        document.write('<iframe style="width:595px; height:' + e + '; background-color: white" frameborder="1" class="wysiwyg" id="' + b + '" name="' + b + '"></iframe>');
    ...
    document.write('<div id="bbeditor_texttool' + b + '">');
    document.write('<table width="100%" cellspacing="0" cellpadding="0" border="0">');
    document.write('<tr>');
    ...
    document.write('<textarea wrap="auto" ' + print_dir + ' rows="10" cols="60" style="width:590px; height:' + e + '; font-family: Verdana, Arial, Sans-Serif, Tahoma; font-size: 12px; color: black; border: 1px solid #6593CF;" class="wysiwyg" id="textarea_' + b + '" name="textarea_' + b + '">' + j + '</textarea>');
    ...
    document.write('<tr>');
    document.write('<td align="left" nowrap="nowrap" style="height:7px; font-size: 8pt; font-family: Verdana, Tahoma, Arial, sans-serif;">' + v + '</td>');
    document.write('</tr>');
    document.write('</table>');
    document.write('<input type="hidden" id="bbeditor_html_ouput_' + b + '" name="bbeditor_html_ouput_' + b + '" value="" />');
    document.write('<input type="hidden" id="bbeditor_bbcode_ouput_' + b + '" name="bbeditor_bbcode_ouput_' + b + '" value="" />');
...
function run_iespell()
{
    ...
    catch(exception)
    {
        ...
        {
            if (confirm(alertNoIESpell)) window.open(IESpellURL)
        }
        else
        {
            alert(IESpellError)
...
function SetFontFormat(a, b)
{
    ...
    if (isIE && e == 'hilitecolor' || isSafari && e == 'hilitecolor') e = 'backcolor';
...
function add_image(a)
{
    ...
    if ((imagePath != null) && (imagePath != ""))
    {
        write_html("<img src=" + imagePath + ">", a)
    }
}
...
{
    buttonElement = document.getElementById(b + '_' + a); // fontsize_bbeditor, forecolor_bbeditor, fontname_bbeditor
    frames['insert_elm'].location.href = c;
    
    var X = get_offset_left(buttonElement);
    var Y = get_offset_top(buttonElement) + buttonElement.offsetHeight;
    //var X = 0 + buttonElement.offsetHeight;
    //var Y = 135;
	...
	document.getElementById('insert_pop').style.marginLeft  = '-200px';
    document.getElementById('insert_pop').style.marginTop  = '-670px';
    document.getElementById('insert_pop').style.zIndex  = '10';
...
if (isSafari)
{
    ...
    document.writeln("<div onclick=\"document.getElementById('Hoteditor_Font_Size').style.display='none';\" class=\"wysiwyg_popuplayer\" id=\"Hoteditor_Font_Size\" style='cursor:hand;cursor:pointer;display:none;position:absolute; top:0; left:0;height:" + fontsize_frame_height + ";width:" + fontsize_frame_width + "'><table class=\"wysiwyg_popuplayer\" width=" + fontsize_frame_width + "><tr class=\"wysiwyg_popuplayer_title\"><td nowrap>Font Size</td><td><img title='Close' style='CURSOR:hand; CURSOR:Pointer' onmouseover=\"this.src='" + wysiwyg_path + "/close_popup_over.gif';\" onmouseout=\"this.src='" + wysiwyg_path + "/close_popup.gif';\" src=" + wysiwyg_path + "/close_popup.gif align=absmiddle></td></tr></table><div style='width:" + fontsize_frame_width + ";height:" + fontsize_frame_height + "'><table class=\"wysiwyg_select\" cellpadding=\"0\" cellspacing=\"0\" width=\"" + fontsize_frame_width + "\">\n");
    ...
    document.writeln("<div onclick=\"document.getElementById('Hoteditor_Font_Name').style.display='none';\" class=\"wysiwyg_popuplayer\" id=\"Hoteditor_Font_Name\" style='cursor:hand;cursor:pointer;display:none;position:absolute; top:0; left:0;height:" + fontname_frame_height + ";width:" + fontname_frame_width + "'><table class=\"wysiwyg_popuplayer\"><tr class=\"wysiwyg_popuplayer_title\"><td nowrap width=" + fontname_frame_width + "><span style='float:left'>Select Font Face</span><img title='Close' style='float:right;CURSOR:hand; CURSOR:Pointer' onmouseover=\"this.src='" + wysiwyg_path + "/close_popup_over.gif';\" onmouseout=\"this.src='" + wysiwyg_path + "/close_popup.gif';\" src=" + wysiwyg_path + "/close_popup.gif align=absmiddle></td></table><div style='overflow:auto;width:" + fontname_frame_width + ";height:" + fontname_frame_height + "'><table class=\"wysiwyg_select\" cellpadding=0 cellspacing=0 width=" + fontname_frame_width + " height=" + fontname_frame_height + ">\n");
    ...
    document.writeln("</table></div></div>\n");
    document.writeln("<div onclick=\"document.getElementById('Hoteditor_Select_Color').style.display='none';\" class=\"wysiwyg_popuplayer\" id=\"Hoteditor_Select_Color\" style='cursor:hand;cursor:pointer;display:none;position:absolute; top:0; left:0;'><table class=\"wysiwyg_popuplayer\"><tr class=\"wysiwyg_popuplayer_title\"><td width=78px nowrap><span style='float:left'>Color</span> <img style='float:right' title='Close' style='CURSOR:hand; CURSOR:Pointer' onmouseover=\"this.src='" + wysiwyg_path + "/close_popup_over.gif';\" onmouseout=\"this.src='" + wysiwyg_path + "/close_popup.gif';\" src=" + wysiwyg_path + "/close_popup.gif align=absmiddle></td></tr></table><div style='overflow:auto;height:" + fontsize_frame_height + "px'><table class=\"wysiwyg_select\" cellpadding=0 cellspacing=0 >\n");
...
function parse_html_to_bbcode(a)
{
    if (starup == "0")
    {
        ...
        if (isIE || isOpera9) a = a.replace(/<blockquote[^>]*>/gi, '<blockquote>');
...
/*======================================================================*\
|| ####################################################################
|| # CVS: $RCSfile: functions_wysiwyg_source.js,v $ - $Revision: 2.00 $
|| ####################################################################
\*======================================================================*/