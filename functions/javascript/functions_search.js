...
function enable_input_group(inputgroup, checkbool, force)
{
	...
	else if (inputgroup == 'productlisted')
	{
		...
		else
		{
			...
			fetch_js_object('productendstart').value = 1;
			fetch_js_object('productendstart_filter').value = -1;
		}
	}
	...
	else if (inputgroup == 'productbidrange')
	{
		...
		else
		{
			...
			fetch_js_object('productbidrange').value = -1;
		}
	}
	...
	else if (inputgroup == 'productlistingtype')
	{
		if (checkbool)
		{
			...
			if (LUB == '1')
			{
				fetch_js_object('css_cb_buyingformat2_5').className = 'black';
				fetch_js_object('cb_buyingformat2_5').disabled = false;
			}
		...
		else
		{
			...
			if (LUB == '1')
			{
				fetch_js_object('css_cb_buyingformat2_5').className = 'gray';
				fetch_js_object('cb_buyingformat2_5').disabled = true;
			}
			fetch_js_object('css_cb_buyingformat2_6').className = 'gray';
			fetch_js_object('cb_buyingformat2_6').disabled = true;
		}
	}
	else if (inputgroup == 'productlistingtype_search')
	{
		if (checkbool)
		{
			fetch_js_object('css_cb_buyingformat2_1').className = 'black';
		...
		else
		{
			...
			fetch_js_object('css_cb_buyingformat2_2').className = 'gray';
			fetch_js_object('cb_productlistingtype').disabled = false;
			fetch_js_object('cb_buyingformat2_1').checked = false;
			fetch_js_object('cb_buyingformat2_2').checked = false;
			fetch_js_object('cb_buyingformat2_1').disabled = true;
			fetch_js_object('cb_buyingformat2_2').disabled = true;
			if (LUB == '1')
			{
	...
	else if (inputgroup == 'productoptions')
	{
		...
		else
		{
			...
			fetch_js_object('buynow2_1').checked = false;
			fetch_js_object('images2_1').checked = false;
			fetch_js_object('pboard2_1').checked = false;
			fetch_js_object('freesh2_1').checked = false;
			fetch_js_object('laslot2_1').checked = false;
	...
	else if (inputgroup == 'productoptions_search')
	{
		if (checkbool)
		{
			fetch_js_object('css_buynow2_1').className = 'black';
			fetch_js_object('css_images2_1').className = 'black';
			fetch_js_object('css_laslot2_1').className = 'black';
			fetch_js_object('buynowe2_1').disabled = false;
			fetch_js_object('imageses2_1').disabled = false;
			fetch_js_object('laslotse2_1').disabled = false;
			
			if (force)
			{
				fetch_js_object('cb_productoptionssearch').checked = true;
			}			
		}
		else
		{
			...
			fetch_js_object('css_images2_1').className = 'gray';
			fetch_js_object('css_laslot2_1').className = 'gray';
			fetch_js_object('buynowe2_1').checked = false;
			fetch_js_object('imageses2_1').checked = false;
			fetch_js_object('laslotse2_1').checked = false;
			fetch_js_object('buynowe2_1').disabled = true;
			fetch_js_object('imageses2_1').disabled = true;
			fetch_js_object('laslotse2_1').disabled = true;
		}
	}
	else if (inputgroup == 'pricerange')
	{
		...
		else
		{
			...
			fetch_js_object('frompricerange').value = '0.01';
			fetch_js_object('topricerange').value = '';
		}
	}
}
