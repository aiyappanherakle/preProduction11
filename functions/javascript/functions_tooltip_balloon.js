...
* @subpackage  	iLance_Functions_Javacript_ToolTip_Balloon
...
config. BalloonImgPath		= IMAGEBASE + "icons/" // Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.
