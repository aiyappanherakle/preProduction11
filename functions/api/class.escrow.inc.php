...
class escrow
{
        ...
        */
        ...
        {
                global $ilance, $myapi, $ilconfig, $phrase, $ilconfig;
                        ...
                        if ($filter_escrow == '1')
                        {
                                ...
                                if ($ilance->db->num_rows($sql) > 0)
                                {
                                        ...
                                        if ($result['escrow_id'] > 0)
                                        {
                                                ...
                                                {
                                                        $result2 = $ilance->db->fetch_array($sql2);
        ...
        */
        function cancel_unlinked_escrow_invoices()
        {
                ...
                if ($ilconfig['escrowsystem_enabled'])
                {
                                ...
                                while ($resms = $ilance->db->fetch_array($sql))
                                {
                                        ...
                                        if ($ilance->db->num_rows($sqlec) == 0)
                                        {
                                                ...
                                                $ilance->db->query("
                                                        ...
                                                        custommessage = '" . $ilance->db->escape_string($phrase['_transaction_cancelled_due_to_unlinked_and_unpaid_escrow_account_for_this_specific_invoice']) . "'
                        ...
                        {
                                $sent = 0;
                                while ($resin = $ilance->db->fetch_array($sql))
                                {
