...
$query="insert into ilance_daily_report_split (report_date,payment_per_method,total_payments,total_amount,total_shipping_cost,total_tax,buyer_fee_total,inhouse_hammer_total,noninhouse_hammer_total,total_revenue,unpaid_invoices_buyerfeesb4_13,unpaid_invoices_buyerfees_after_13,unpaid_item_amountb4_13,unpaid_item_amount_after_13,pending_total_2012,pending_total_2013,checkedout_invoices_buyerfees,checkedout_amount,checked_out_total,total_Ar,house_acc_sold_coin_cost,profit_sold_house_acc_coin,remaining_house_acc_inventory,unbooked_buynow) values ('".$reportdate."',
...
sum(CASE WHEN i.createdate>='2013-1-1 00:00:00' and IFNULL(n.invoiceid,0) THEN i.totalamount ELSE 0 END) as unpaid_invoices_buyerfees_after_13
