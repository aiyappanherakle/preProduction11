...
class xajax
{
	...
	function getJavascriptInclude($sJsURI="", $sJsFile=NULL)
	{
		...
		if ($sJsFile == NULL) $sJsFile = $ilconfig['template_relativeimagepath'] . 'functions/javascript/functions_xajax.js';
			
		if ($sJsURI != "" && mb_substr($sJsURI, -1) != "/") $sJsURI .= "/";
		...
		/*$html .= "window.setTimeout(function () {  xajax_print_next_category('8569', 'catbox_1'); }, 500);\n";
		$html .= "window.setTimeout(function () {  xajax_print_next_category('102327', 'catbox_2'); }, 1500);\n";
		$html .= "window.setTimeout(function () {  xajax_print_next_category('118500', 'catbox_3'); }, 2000);\n";
		$html .= "window.setTimeout(function () {  xajax_print_next_category('118501', 'catbox_4'); }, 2500);\n";*/
		$html .= "\t</script>\n";
		return $html;
	}
