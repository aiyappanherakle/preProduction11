...
class cashu
{
        ...
        */
        ...
        {
                $html = '
                <form method="post" action="https://www.cashu.com/cgi-bin/pcashu.cgi" accept-charset="UTF-8" style="margin:0px">
		...
		//feb 24 herakle
		 function print_payment_form_check($userid = 0, $payer_email = '', $amount = 0, $invoiceid = 0, $subscriptionid = 0, $description = '', $merchantid = '', $currency = '', $passphrase = '', $customencrypted = '', $testmode = 0)
        {
		   global $ilconfig, $ilpage;
		
                $html = '
                <form method="post" action="'.$ilpage[invoicepayment].'"  onsubmit="combine_trigger('.$invoiceid.')"  accept-charset="UTF-8" style="margin:0px">
				<input type="hidden" name="cmd" value="_do-invoice-payment-checkorder" />
        ...
        function print_payment_form_check_staff($userid = 0, $payer_email = '', $amount = 0, $invoiceid = 0, $subscriptionid = 0, $description = '', $merchantid = '', $currency = '', $passphrase = '', $customencrypted = '', $testmode = 0)
        {
           global $ilconfig, $ilpage;
        
                $html = '
                <form method="post" onsubmit="combine_trigger('.$invoiceid.')"  accept-charset="UTF-8" style="margin:0px">
                <input type="hidden" name="cmd" value="_do-invoice-payment-checkorder" />
                <input type="hidden" name="userid" value="' . $userid . '" />
                <input type="hidden" name="display_text" value="' . $description . '" />
                <input type="hidden" name="currency" value="' . $currency . '" />
		 ...
		 function print_payment_form_bank($userid = 0, $payer_email = '', $amount = 0, $invoiceid = 0, $subscriptionid = 0, $description = '', $merchantid = '', $currency = '', $passphrase = '', $customencrypted = '', $testmode = 0)
        {
		   global $ilconfig, $ilpage;
		
                $html = '
                <form method="post" action="'.$ilpage[invoicepayment].'"  onsubmit="combine_trigger('.$invoiceid.')"  accept-charset="UTF-8" style="margin:0px">
				<input type="hidden" name="cmd" value="_do-invoice-payment-bank" />
                <input type="hidden" name="userid" value="' . $userid . '" />
                <input type="hidden" name="display_text" value="' . $description . '" />
                <input type="hidden" name="currency" value="' . $currency . '" />
                <input type="hidden" name="amount" value="' . $amount . '" />
        ...
        function print_payment_form_bank_staff($userid = 0, $payer_email = '', $amount = 0, $invoiceid = 0, $subscriptionid = 0, $description = '', $merchantid = '', $currency = '', $passphrase = '', $customencrypted = '', $testmode = 0)
        {
           global $ilconfig, $ilpage;
		...
		// murugan added july 20 for trade against consignor pay method
		
		 function print_payment_form_trade($userid = 0, $payer_email = '', $amount = 0, $invoiceid = 0, $subscriptionid = 0, $description = '', $merchantid = '', $currency = '', $passphrase = '', $customencrypted = '', $testmode = 0)
        {
		   global $ilconfig, $ilpage;
		
                $html = '
                <form method="post" action="'.$ilpage[invoicepayment].'"  onsubmit="combine_trigger('.$invoiceid.')"  accept-charset="UTF-8" style="margin:0px">
				<input type="hidden" name="cmd" value="_do-invoice-payment-trade" />
                <input type="hidden" name="userid" value="' . $userid . '" />
                <input type="hidden" name="display_text" value="' . $description . '" />
                <input type="hidden" name="currency" value="' . $currency . '" />
                <input type="hidden" name="amount" value="' . $amount . '" />
         ...
         function print_payment_form_trade_staff($userid = 0, $payer_email = '', $amount = 0, $invoiceid = 0, $subscriptionid = 0, $description = '', $merchantid = '', $currency = '', $passphrase = '', $customencrypted = '', $testmode = 0)
        {
           global $ilconfig, $ilpage;
        ...
        */
        function error_out($text = '')
        {
                ...
                if ($this->error_email)
                {
                        send_email($this->error_email, 'CashU IPN Gateway Error', $message, SITE_EMAIL);
                }
        }
}
