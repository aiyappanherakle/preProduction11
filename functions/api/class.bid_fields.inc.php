                                        ...
                                        if ($this->can_display_bid_field($res['fieldid'], $cid))
                                        {
                                                ...
                                                switch ($res['inputtype'])
                                                {
                                                        case 'yesno':
                                                        {
                                                                ...
                                                                $input = '<label for="' . $res['formname'] . '1"><input type="radio" id="' . $res['formname'] . '1" name="custom[' . $res['questionid'] . '][' . $res['formname'] . ']" value="1" ' . $checked1 . ' /> ' . $phrase['_yes'] . '</label> <label for="' . $res['formname'] . '2"><input type="radio" id="' . $res['formname'] . '2" name="custom[' . $res['questionid'] . '][' . $res['formname'] . ']" value="0" ' . $checked2 . ' /> ' . $phrase['_no'] . '</label>';
                                                                $overridejs = 1;
                                                                break;
                                                        }                                
                                                        case 'int':
                                                        ...
                                                        case 'textarea':
                                                        {
                                                                ...
                                                                $input = '<div class="ilance_wysiwyg"><textarea id="' . $res['formname'] . '" name="custom[' . $res['questionid'] . '][' . $res['formname'] . ']" style="width:580px; height:84px; padding:8px; font-family: verdana" wrap="physical">' . $value . '</textarea><br /><div style="width:300px;"><a href="javascript:void(0)" onclick="return construct_textarea_height(\'' . $res['formname'] . '\', 100)">' . $phrase['_increase_size'] . '</a>&nbsp;<a href="javascript:void(0)" onclick="return construct_textarea_height(\'' . $res['formname'] . '\', -100)">' . $phrase['_decrease_size'] . '</a></div></div>';
                                                                break;
                                                        }
                                                        case 'text':
                                                        {
                                                        ...
                                                        case 'multiplechoice':
                                                        {
                                                                if (!empty($res['multiplechoice']))
                                                                {
                                                                        ...
                                                                        $input = $phrase['_hold_down_the_ctrl_key_on_your_keyboard_to_select_multiple_choices'] . '<br />';
...
";
                                        ...
                                        if (isset($answer) AND (!empty($answer) OR $answer != ''))
                                        {
                                                ...
                                                switch ($res['inputtype'])
                                                {
                                                        case 'yesno':
                                                        {
                                                                if ($answer == 1)
                                                                {
                                                                        $htmlanswer .= $phrase['_yes'];
                                                                }
                                                                else
                                                                {
                                                                        $htmlanswer .= $phrase['_no'];
                                                                }
                                                                break;
                                                        }
                                                        case 'int':
                                                        ...
                                                        case 'pulldown':
                                                        {
                                                                if (!empty($answer) OR $answer != '')
                                                                {
                                                                        ...
                                                                        if (empty($fix))
                                                                        {
                                                                                $htmlanswer .= ($show['is_owner'] ? '<span style="float:right" class="smaller">[ <a href="' . $ilpage['selling'] . '?cmd=product-management&amp;state=' . $type . '&amp;id=' . intval($ilance->GPC['id']) . '#categoryfinder">' . $phrase['_edit'] . '</a> ]</span>-' : '-');
                                                                        }
                                                                        else
                                                                        {
                                                                                $htmlanswer .= $fix;
                ...
                if ($separator)
                {
                        $html .= '<hr size="1" width="100%" style="color:#cccccc" />';
                }
        ...
        * @return      null
        */
        function process_custom_bid_fields($custom = array(), $projectid = 0, $bidid = 0)
        {
                global $ilance;
        ...
        */
        function print_bid_field_checkboxes($cid = 0, $slng = 'eng')
        {
                ...
                if (empty($html))
                {
                        $html .= '<a href="' . $ilpage['distribution'] . '?cmd=bids">' . $phrase['_create_new_bid_fields'] . '</a>';
                }
