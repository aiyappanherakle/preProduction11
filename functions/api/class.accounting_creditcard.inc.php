...
/**
* Function to handle credit card logic
*
* @package      iLance
...
class accounting_creditcard extends accounting
{
        ...
        */
        function process_creditcard_deposit($ccid = 0, $userid = 0, $deposit = 0, $credit = 0, $custom = array())
        {
                ...
                $ilance->paymentgateway->set_order(
                        $deposit,
                        $transa,
                        $phrase['_account_deposit_credit_via'] . ' ' . ucfirst($resultcc['creditcard_type']) . ' : #' . $ccnum_hidden . ' ' . $phrase['_into_online_account'],
                ...
                if ($ilance->paymentgateway->process())
                {
                        ...
                        $deposit_invoice_id = $ilance->accounting->insert_transaction(
                                ...
                                0,
                                0,
                                $phrase['_account_deposit_credit_via'] . ' ' . ucfirst($resultcc['creditcard_type']) . ' : #' . $ccnum_hidden . ' ' . $phrase['_into_online_account'] . ': ' . $ilance->currency->format($credit),
                                $deposit,
                                $deposit,
                                'paid',
                                'credit',
	...
	/**
        ...
        */
        ...
        {
                global $ilance, $myapi, $phrase, $page_title, $area_title, $ilconfig, $ilpage, $SCRIPT_URL;
                ...
                $ilance->paymentgateway->set_order(
                        $amount1,
                        $transa1,
                        $phrase['_credit_card_authentication_amount_one'],
                        $ilconfig['authentication_capture'],
                        null,
                        null,
                        null
                ...
                $ilance->paymentgateway2->set_order(
                        $amount2,
                        $transa2,
                        $phrase['_credit_card_authentication_amount_two'],
                        $ilconfig['authentication_capture'],
                        NULL,
                        NULL,
                        NULL
        ...
        function creditcard_authentication_step_two($input_auth = '', $v3customer_ccid = '', $v3customer_fname = '', $v3customer_lname = '', $v3customer_address = '', $v3customer_city = '', $v3customer_state = '', $v3customer_zip = '', $v3customer_country = '')
        {
                ...
                if ($server_sum == $input_auth)
                {
                        ...
                        if ($ilconfig['authentication_refund_on_max_cc_attempts'])
                        {
                                ...
                                {
                                        $header_text = $phrase['_credit_card_refund_to_card_failure'];
                                        $body_text = $phrase['_were_sorry_there_seems_to_have_been_a_problem_during_the_recredit_operation_to_your_credit_card'];
                                        
                                        print_notice($header_text, $body_text, $ilpage['accounting'], $phrase['_accounting']);
                                }
                        }
                        else
                        {
                                ...
                                $ilance->db->query("
                                        ...
                                        '" . $ilance->db->escape_string($phrase['_credit_card_authentication_refund_credit_into_online_account']) . "',
        ...
        */
        function creditcard_authentication_refund($input_auth = '', $v3customer_ccid = '', $v3customer_fname = '', $v3customer_lname = '', $v3customer_address = '', $v3customer_city = '', $v3customer_state = '', $v3customer_zip = '', $v3customer_country = '')
        {
                ...
                $ilance->paymentgateway->set_order(
                        $res['auth_amount1'],
                        $res['trans1_id'],
                        $phrase['_credit_card_authentication_failure_refund_one_of_two'],
                ...
                else
                {
                        ...
                        $ilance->db->query("
                                ...
                                '" . $ilance->db->escape_string($phrase['_credit_card_authentication_refund_one_of_two']) . "',
                                '" . $res['auth_amount1'] . "',
                                '" . $res['auth_amount1'] . "',
                                '" . $res['auth_amount1'] . ",
                                'paid',
                                ...
                                '" . DATEINVOICEDUE . "',
                                '" . DATETIME24H . "',
                                '" . $ilance->db->escape_string($phrase['_credit_card_authentication_refund_credit_to_credit_card']) . "',
                                '" . construct_transaction_id() . "',
                                '0')
                        ", 0, null, __FILE__, __LINE__);
                }
                ...
                if ($v3process_success)
                {
                        ...
                        $ilance->paymentgateway->set_order(
                                $res['auth_amount2'],
                                $res['trans2_id'],
                                $phrase['_credit_card_authentication_failure_refund_two_of_two'],
                                $ilconfig['authentication_refund'],
                                $ilconfig['authentication_refund']
                        );
                        ...
                        else
                        {
                                ...
                                $ilance->db->query("
                                        ...
                                        NULL,
                                        '" . $ilance->db->fetch_field(DB_PREFIX . "creditcards", "cc_id=" . $v3customer_ccid, "user_id") . "',
                                        '" . $ilance->db->escape_string($phrase['_credit_card_authentication_refund_two_of_two']) . "',
