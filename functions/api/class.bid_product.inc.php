        ...
        */
		...
		$resexpiry = array();
                $sqlexpiry = $ilance->db->query("
                        SELECT UNIX_TIMESTAMP(date_end) - UNIX_TIMESTAMP('" . $datetime . "') AS mytime, status, cid, bids, project_title, buynow, buynow_price, buynow_qty, reserve, reserve_price, currentprice
