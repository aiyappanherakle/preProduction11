...
class moneybookers
{
        ...
        */
        ...
        function generate_md5_digest()
        {
                ...
                $md5 = md5($ilconfig['moneybookers_secret_code']);
                $md5 = mb_strtoupper($md5);
        ...
        */
        function print_payment_form($userid = 0, $payer_email = '', $amount = 0, $invoiceid = 0, $subscriptionid = 0, $description = '', $merchantid = '', $currency = '', $passphrase = '', $customencrypted = '', $testmode = 0)
        {
                ...
                $html = '
                <form method="post" action="https://www.moneybookers.com/app/payment.pl" accept-charset="UTF-8" style="margin:0px">
                ...
                <input type="hidden" name="detail1_text" value="' . $phrase['_into_online_account'] . '" />
        ...
        */
        function print_recurring_payment_form($merchantid = '', $amount = 0, $units = '', $length = 0, $description = '', $currency = '', $customencrypted = '', $onsubmit = '')
        {
                ...
                $html = '
                <form method="post" action="https://www.moneybookers.com/app/payment.pl" onsubmit="' . $onsubmit . '" accept-charset="UTF-8" style="margin:0px">
                <input type="hidden" name="pay_to_email" value="' . $merchantid . '" />
                <input type="hidden" name="detail1_description" value="' . $description . '" />
        ...
        */
        function is_verified()
        {
                ...
                {
                        if ($ilconfig['moneybookers_md5_digest'])
                        {
        ...
        */
        function error_out($text = '')
        {
                ...
                if ($this->error_email)
                {
                        send_email($this->error_email, 'MoneyBookers IPN Gateway Error', $message, SITE_EMAIL);
                }
        }
}
