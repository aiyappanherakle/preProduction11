...
class bbcode
{
        ...
        */
        function bbcode_to_html($text = '', $doamperstand = false)
        {
                ...
                $pattern[] = "#\[hr\]#si";
                $replace[] = '<hr size="1" style="color:#cccccc" width="100%" />';	
                ...
                $pattern[] = "#\[url=(.*?)\]#si";
                $replace[] = '<span class="blue"><a href="$1" target="_self">';
        ...
        */
        function html_to_bbcode($text = '')
        {
                ...
                // search all supported html tags to be converted into bbcode
                $search = array(
                        "'<pre>(.*)</pre>'siU",
                        "'<b>(.*)</b>'siU",
                        "'<strong>(.*)</strong>'siU",
                ...
                // find unwanted tags like [P][/P], [B][/B], etc
                $search = array(
                        "[P][/P]",
                        "[B][/B]",
                        "[I][/I]",
        ...
        */
        function bbcode_quote_handler(&$output)
        {
                ...
                $replace[] = '<div class="quotereply"><div style="padding-bottom:6px" class="smaller gray">Quote originally posted by <span class="blue"><strong>$1</strong>:</span></div><div><span style="font-family: verdana; color:#555"><em>$3</em></span></div></div>';
                $output = preg_replace($pattern, $replace, $output);
                
                $pattern[] = "#\[QUOTE=(.*?)\](.*?)\[\/QUOTE\]#si";
                $replace[] = '<div class="quotereply"><div style="padding-bottom:6px" class="smaller gray">Quote originally posted by <span class="blue"><strong>$1</strong>:</span></div><div><span style="font-family: verdana; color:#555"><em>$2</em></span></div></div>';
                $output = preg_replace($pattern, $replace, $output);
