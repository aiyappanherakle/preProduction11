...
|| # This File Created By vijay, Notify Auction Win report For cron  	  # ||
|| # -------------------------------------------------------------------- # ||
		...
		while($sql_uid_coin = $ilance->db->fetch_array($sql_uid))
		{
			...
			{	
				...
				{  
					...
					$pending_in_amt=$amounttotal+$shipper_drop_down;
...
/*======================================================================*\
|| ####################################################################
|| #worked for notify win and invoice remainder with base shipping fee#
|| ####################################################################
\*======================================================================*/
?>
