...
{
$select = $ilance->db->query("SELECT distinct user_id from ".DB_PREFIX."consignments order by user_id");
}
...
{
$FETCH_USER=$ilance->db->fetch_array($ilance->db->query("SELECT * from ".DB_PREFIX."users where user_id='".$res_user['user_id']."'"));
...
$user_coin_list = $ilance->db->query("SELECT c.* FROM ".DB_PREFIX."coins c,".DB_PREFIX."invoices i
WHERE (date(i.createdate) >= '".$ilance->GPC['start_date']."' AND date(i.createdate) <= '".$ilance->GPC['end_date']."')
AND c.user_id='".$res_user['user_id']."'
AND c.coin_id=i.projectid
AND i.buynowid=0
AND i.isfvf=0
...
group by project_id	ORDER BY owner_id
");


//suku removed buynow from here
if($list_count>0 or $listcount>0)
{
$table1.='<tr><td>&nbsp;</td></tr><tr><td>Gross Total</td><td ></td><td ></td><td ></td><td ></td><td nowrap><b>'.$totfvf.'</b></td><td nowrap><b>'.$totlisting_fee.'</b></td><td nowrap><b>'.$totseller_fee.'</b></td><td nowrap><b>'.$totnet_consignor.'</b></td></tr><tr ><td>&nbsp;</td></tr><tr><td nowrap></td><td nowrap></td><td nowrap></td><td nowrap></td><td nowrap></td><tdnowrap>Advance </td><td></b></td><td></b></td><td nowrap><b>'.$total_advance.'</b></td></tr><tr><tdnowrap></td><td nowrap></td><td nowrap></td><td nowrap></td><td nowrap></td><td nowrap>Miscellaneous </td><td></b></td><td></b></td><td nowrap><b>'.$tot_mis.'</b></td></tr><tr><td nowrap></td><td nowrap></td><td nowrap></td><td nowrap></td><tdnowrap></td><td nowrap>Paid </td><td></b></td><td></b></td><td nowrap><b>'.$def .'</b></td></tr><tr><td nowrap></td><td nowrap></td><td nowrap></td><td nowrap></td><td nowrap></td><tdnowrap>Balance </td><td></b></td><td></b></td><td nowrap><b>'.$lastamount.'</b></td></tr></table>';
