...
{ 
  ...
  //invoice with partial payments on that date
			...
			$query1="SELECT i.paiddate,i.invoiceid,i.paid,i.paymethod,u.first_name,u.last_name,u.user_id,p.paymentdate,p.paymethod as partial_paymethod,p.partial_amount,CASE i.status
													WHEN 'paid' THEN '1040'
													ELSE '1060'
													END AS status    
			...
			$res['paymethod'] 	= $line1['paymethod']; */
					...
					$res['descripton'] 	= $line1['first_name'].' '.$line1['last_name'].'  ['.$line1['user_id'].']';
						$res['Method']	= $line1['paymethod'];
						$res['Status']	= $line1['status'];
