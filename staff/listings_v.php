...
if (!empty($_SESSION['ilancedata']['user']['userid']) AND $_SESSION['ilancedata']['user']['userid'] > 0 AND $_SESSION['ilancedata']['user']['isstaff'] == '1')
{
   ...
   if (isset($ilance->GPC['cmd']) AND $ilance->GPC['cmd'] == 'insert_return_user')
   {
					...
					//suku corrected
					$con_insert1 = $ilance->db->query("INSERT INTO " . DB_PREFIX . "coins_retruned SELECT * FROM ilance_coins where coin_id='".$ilance->GPC['coin_id']."'", 0, null, __FILE__, __LINE__);
					
					$con_insert2 = $ilance->db->query("delete FROM ilance_coins where coin_id='".$ilance->GPC['coin_id']."'", 0, null, __FILE__, __LINE__);
