...
$query1="SELECT coin_id,ebay_id,date(end_date) as end_date , DATE_ADD(end_date,INTERVAL 30 DAY) as  end_date_plus_thirty_days FROM " . DB_PREFIX . "ebay_listing  where status='listed'";
