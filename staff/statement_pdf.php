...
//error_reporting(E_ALL);
		...
		$select = $ilance->db->query("
					SELECT distinct co.user_id,u.username,u.email,u.first_name,u.last_name,u.address,u.address2,u.city,u.state,u.zip_code 
					FROM ".DB_PREFIX."coins co,".DB_PREFIX."users u  		
