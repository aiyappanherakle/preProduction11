			...
			else
			{
				 ...
				 $sqlcat_user_detail = $ilance->db->query("
								 ...
								 if($ilance->db->num_rows($sqlcat_coin_detail) > 0)
										...
										{	
										 ...
										 else
										 {
											 ...
											 {
											 $certified = '<strong>Certified Coin</strong> <a href="consignments_fast.php?cmd=add_single_coin&subcmd=update_edit&user_id='.$ilance->GPC['user_id'].'&consignid='.$ilance->GPC['consignid'].'&pro='.fetch_user_attach('project_id',$row_coin_list['coin_id']).'&coin_id='.$row_coin_list['coin_id'].'">(Update)</a>';
											 }
											 else
											 {
										...
										$row_coin_list['desci'] = '<span class="blue"><a href="consignments_fast.php?cmd=add_single_coin&subcmd=update_edit&user_id='.$ilance->GPC['user_id'].'&consignid='.$ilance->GPC['consignid'].'&pro='.fetch_user_attach('project_id',$row_coin_list['coin_id']).'&coin_id='.$row_coin_list['coin_id'].'">'.$row_coin_list['Title'].'</a></span>';	
												
									    $row_coin_list['coinid'] = 	'<span class="blue"><a href="consignments_fast.php?cmd=add_single_coin&subcmd=update_edit&user_id='.$ilance->GPC['user_id'].'&consignid='.$ilance->GPC['consignid'].'&pro='.fetch_user_attach('project_id',$row_coin_list['coin_id']).'&coin_id='.$row_coin_list['coin_id'].'">'.$row_coin_list['coin_id'].'</a></span>';	
					...
					$sqlcat_coin_count = $ilance->db->query("
								...
								{
								$newadd =  '<a href="consignments_fast.php?cmd=add_single_coin&user_id='.$ilance->GPC['user_id'].'&consignid='.$ilance->GPC['consignid'].'">Add Another Coin</a>';
								}
								else
								{
								$addsinglecoin = '<a href="consignments_fast.php?cmd=add_single_coin&user_id='.$ilance->GPC['user_id'].'&consignid='.$ilance->GPC['consignid'].'">Add New Single Coin</a>';
	...
	if (isset($ilance->GPC['subcmd']) AND $ilance->GPC['subcmd'] == 'search_now')
	{
	 ...
	 if(empty($ilance->GPC['pcgs']) and empty($ilance->GPC['subcmd']))
	 {
		...
		while($search_result = $ilance->db->fetch_array($query_search))
			{
$search_result['desci'] = '<span class="blue"><a href="consignments_fast.php?cmd=add_single_coin&subcmd=update_edit&user_id='.$search_result['user_id'].'&consignid='.$search_result['consignid'].'&pro='.fetch_user_attach('project_id',$search_result['coin_id']).'&coin_id='.$search_result['coin_id'].'">'.$search_result['Title'].'</a></span>';	
								$search_result['pc'] = '<span class="blue"><a href="catalog.php?cmd=update-catalog&subcmd=update-coinlist&id='.fetch_cat('id',$search_result['pcgs']).'">'.$search_result['pcgs'].'</a></span>';				
									    $search_result['coinid'] = 	'<span class="blue"><a href="consignments_fast.php?cmd=add_single_coin&subcmd=update_edit&user_id='.$search_result['user_id'].'&consignid='.$search_result['consignid'].'&pro='.fetch_user_attach('project_id',$search_result['coin_id']).'&coin_id='.$search_result['coin_id'].'">'.$search_result['coin_id'].'</a></span>';
