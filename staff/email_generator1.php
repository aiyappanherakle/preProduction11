...
$head = '<div><font face="arial" style="font:x-small" color="#000000"><br/></font></div>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
</head>
<body><table width="598" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td width="598" style="border-collapse:collapse;"><!-- start PREHEADER TABLE -->
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
<tr>
<td width="60%" style="border-collapse:collapse; padding-bottom:10px; font-family:verdana,arial; font-size:10px; text-align:left; line-height:13px; color:#999999;">
...
<td width="40%" style="border-collapse:collapse; padding-bottom:10px; font-family:verdana,arial; font-size:10px; text-align:right; line-height:13px; color:#999999;">
{VR_SOCIAL_SHARING}<br /><a href="{VR_F2AF_LINK}">Forward to a Friend</a>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="background-color:#DEE7EC; background:url(\'http://www.greatcollections.com/images/gc/globalnavbg.gif\') center left repeat-x #DEE7EC;">
    <tr>
      <td width="350" height="17" align="center" style="border:1px solid #B0C4CF; border-bottom:none; border-collapse:collapse; background-color:#DEE7EC; background:url(\'http://www.greatcollections.com/images/gc/globalnavbg.gif\') center left repeat-x #DEE7EC; color:#555555;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign="middle" style="background-color:#DEE7EC; background:url(\'http://www.greatcollections.com/images/gc/globalnavbg.gif\') center left repeat-x #DEE7EC;">

          <tr>
            <td align="center" style="border-collapse:collapse;"><a href="http://www.greatcollections.com/main.php?referal_name=email01" style="margin:0; padding:0 3px 0 7px; color:#336699; font-family:verdana,arial; font-size:10px; font-weight:bold; text-decoration:none;">GreatCollections.com</a></td>
            <td align="center" style="border-collapse:collapse;"><a href="http://www.greatcollections.com/main.php?cmd=about&referal_name=email01" style="margin:0; padding:0 3px 0 7px; color:#336699; font-family:verdana,arial; font-size:10px; font-weight:bold; text-decoration:none;">About Us</a></td>
            <td align="center" style="border-collapse:collapse;"><a href="http://www.greatcollections.com/main.php?cmd=sell&referal_name=email01" style="margin:0; padding:0 3px 0 7px; color:#336699; font-family:verdana,arial; font-size:10px; font-weight:bold; text-decoration:none;">Consign</a></td>
            <td align="center" style="border-collapse:collapse;"><a href="http://www.greatcollections.com/main.php?cmd=contact&referal_name=email01" style="margin:0; padding:0 3px 0 7px; color:#336699; font-family:verdana,arial; font-size:10px; font-weight:bold; text-decoration:none;">Contact Us</a></td>
          </tr>
        </table>
...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="border:1px solid #B0C4CF; background:#FFF;">
<tr>
...
<tr>
<td width="600" height="20" valign="middle" style="border-collapse:collapse;">
<!-- start NAV TABLE -->
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="background-color:#2C5987; background:url(\'http://www.greatcollections.com/images/gc/nav-bg.jpg\') center left repeat-x #2C5987;">
    <tr>
      <td width="600" height="21" align="center" style="background-color:#2C5987; background:url(\'http://www.greatcollections.com/images/gc/nav-bg.jpg\') center left repeat-x #2C5987;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign="middle" style="background-color:#2C5987; background:url(\'http://www.greatcollections.com/images/gc/nav-bg.jpg\') center left repeat-x #2C5987;">
          <tr>

  <td align="center" style="border-collapse:collapse;"><a href="http://www.greatcollections.com/merch.php?cmd=listings&referal_name=email01" style="padding:0 6px; font-family:verdana,arial; font-size:11px; color:#fff; text-decoration:none; text-transform:none;">Browse Coins</a></td>
...
<!-- end NAV TABLE --></td>
    ...
    <tr>
      <td width="598" style="border-collapse:collapse; padding:14px;">';
	  
	  $featured='<td align=left width="380">
 ...
 <strong>All first-time U.S. auction winners receive free shipping.</strong>
         <br /><br />
         <A href="https://www.greatcollections.com/registration.php?referal_name=email01"><strong style="color:#336699;">Register to Bid and Be Part of the Action</strong></A><br />
...
$foot = '</td>
    ...
    <tr>
      <td width="598" style="border-collapse:collapse;"><!-- start FOOTER TABLE -->    
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="border-top:1px dashed #929293; text-align:center; background:#E1E9F3;">
  <tr>
    <td width="600" height="20" valign="bottom" align="center" style="padding:0 15px; border-collapse:collapse; background:#E1E9F3;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="background:#E1E9F3;">
        <tr>
  <td align="center" style="border-collapse:collapse;"><a href="https://www.greatcollections.com/main.php?cmd=cp&referal_name=email01" style="padding:0 4px; border-left:none; font-family:verdana,arial; font-size:10px; color:#336699; text-decoration:none; font-weight:bold;">MyGC</a></td>
  <td align="center" style="border-left:1px solid #B0C4CF; border-collapse:collapse;"><a href="http://www.greatcollections.com/watchlist.php?referal_name=email01" style="padding:0 4px; border-left:none; font-family:verdana,arial; font-size:10px; color:#336699; text-decoration:none; font-weight:bold;">Watchlist</a></td>

  <td align="center" style="border-left:1px solid #B0C4CF; border-collapse:collapse;"><a href="http://www.greatcollections.com/main.php?cmd=about&referal_name=email01" style="padding:0 4px; border-left:none; font-family:verdana,arial; font-size:10px; color:#336699; text-decoration:none; font-weight:bold;">About Us</a></td>
  <td align="center" style="border-left:1px solid #B0C4CF; border-collapse:collapse;"><a href="http://www.greatcollections.com/kb/" style="padding:0 4px; border-left:none; font-family:verdana,arial; font-size:10px; color:#336699; text-decoration:none; font-weight:bold;">Help</a></td>
  <td align="center" style="border-left:1px solid #B0C4CF; border-collapse:collapse;"><a href="http://www.greatcollections.com/main.php?cmd=contact&referal_name=email01" style="padding:0 4px; border-left:none; font-family:verdana,arial; font-size:10px; color:#336699; text-decoration:none; font-weight:bold;">Contact Us</a></td>
  <td align="center" style="border-left:1px solid #B0C4CF; border-collapse:collapse;"><a href="http://www.greatcollections.com/main.php?cmd=promise&referal_name=email01" style="padding:0 4px; border-left:none; font-family:verdana,arial; font-size:10px; color:#336699; text-decoration:none; font-weight:bold;">Trust</a></td>
  <td align="center" style="border-left:1px solid #B0C4CF; border-collapse:collapse;"><a href="http://www.greatcollections.com/main.php?cmd=shows&referal_name=email01" style="padding:0 4px; border-left:none; font-family:verdana,arial; font-size:10px; color:#336699; text-decoration:none; font-weight:bold;">Coin Shows</a></td>
</tr>
      </table>
  ...
  <tr>
    <td width="600" height="20" valign="middle" align="center" style="padding:0 10px; border-collapse:collapse; background:#E1E9F3;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="background:#E1E9F3;">
        <tr>
  <td align="center" style="border-collapse:collapse;"><a href="https://www.greatcollections.com/main.php?cmd=through&referal_name=email01" style="padding:0 4px; border-left:none; font-family:verdana,arial; font-size:10px; color:#336699; text-decoration:none; font-weight:bold;">Bidding/Buying Coins Through GreatCollections</a></td>
  <td align="center" style="border-left:1px solid #B0C4CF; border-collapse:collapse;"><a href="http://www.facebook.com/GreatCollections" style="padding:0 4px; border-left:none; font-family:verdana,arial; font-size:10px; color:#336699; text-decoration:none; font-weight:bold;">Facebook</a></td>

  <td align="center" style="border-left:1px solid #B0C4CF; border-collapse:collapse;"><a href="http://twitter.com/greatcollection" style="padding:0 4px; border-left:none; font-family:verdana,arial; font-size:10px; color:#336699; text-decoration:none; font-weight:bold;">Follow Us On Twitter</a></td>
</tr>
      </table>
    </td>
  </tr>
  <tr>
    <td width="600" height="70" valign="top" align="center" style="border-collapse:collapse;">
      ...
      <p style="margin:0; padding:10px 0; font-family:verdana,arial; font-size:10px; color:#555555;">&#169; 2010 - '.CURRENTYEAR.' <a href="http://www.greatcollections.com/main.php?referal_name=email01" style="font-family:verdana,arial; font-size:11px; color:#555555; text-decoration:none; font-size:10px; color:#336699;">GreatCollections.com</a>, LLC<br />2030 Main Street, Suite 620, Irvine, CA 92614<br />
...
$couo = ($ilance->GPC['ck']== 'op') ? $_SESSION['cou'] : 1;
	    ...
	    $ilance->template->fetch('main', 'email_generator1.html',2);
        $ilance->template->parse_hash('main', array('ilpage' => $ilpage));
