...
$projectlist = '<table border="1"><tr><td>Username</td><td>Email</td><td>Itemscount</td><td>UnsoldPrice</td><td>SoldPrice</td></tr></tr>';
...
if($ilance->db->num_rows($project_list)>0)
{
 ...
 $projectlist.='<tr><td></td><td>Total</td><td>'.$total_1.'</td><td>'.$total_2.'</td><td>'.$total_3.'</td>'; 
/*echo $total_1; echo '<br/>';
 echo $total_2; echo '<br/>';                    
echo  $total_3;*/
                          $projectlist.='</table>';
					...
					$p->htmltable($projectlist);

					

					$p->output('project_list_items.pdf','D');
