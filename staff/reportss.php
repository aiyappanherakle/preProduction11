...
//cs.coin_series_sort,cc.coin_detail_year asc,cd.denomination_sort,
		...
		if(isset($ilance->GPC['export']) AND $ilance->GPC['export'] == 'excel')
		{
			...
			if(isset($ilance->GPC['apr_option']) AND $ilance->GPC['apr_option'] == 'with_apr')
			{
				$fields = array('Coin_id','Site','Sold','Title','PCGS ','Certificate No','Min Bid','Buy Now','Bids','APR','Total');
			}
			else
			{
				$fields = array('Coin_id','Site','Sold','Title','PCGS ','Certificate No','Min Bid','Buy Now','Bids','Total');
			}
	...
	$ilance->template->fetch('main', 'reportss.html', 2);
