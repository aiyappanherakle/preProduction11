...
$sql=$ilance->db->query("select user_id,combine_project,taxamount,taxinfo,totalamount,status,createdate,paiddate,amount  from " . DB_PREFIX . "invoices where invoiceid='".$invoice_id."'");
