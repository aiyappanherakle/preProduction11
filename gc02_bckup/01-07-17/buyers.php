...
while($line=$ilance->db->fetch_array($sql))
{
	...
	else
	{
		...
		$pay_button = ' Update Payment Date ';
		$paid_method = print_paymethod_pulldown('paidmethod', $line['paymethod'], $_SESSION['ilancedata']['user']['userid']);
