...
else
{
	...
	$redirect = HTTPS_SERVER.'asst1/users.php';
	...
	if (!empty($_COOKIE[COOKIE_PREFIX . 'username']))
	{
        ...
        if (!empty($_SESSION['ilancedata']['user']['userid']) AND $_SESSION['ilancedata']['user']['isstaff'] == '2' OR  $_SESSION['ilancedata']['user']['isadmin'] == '1')
        {
                header("Location: " . HTTPS_SERVER . 'asst1/users.php');
                exit();
        }
