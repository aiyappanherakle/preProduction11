...
$new_coin="SELECT p.date_starts,p.cid,p.project_id,p.project_title,p.filtered_auctiontype,p.currentprice,p.status,
                    c.coin_id,c.generics,c.Create_Date,
					a.filehash,
					dd.live_date,
...
$detail.= '</td></tr></table>';
        ...
        $ilance->template->fetch('main', 'pre_1933_gold.html');
