...
if (!empty($_SESSION['ilancedata']['user']['userid']) AND $_SESSION['ilancedata']['user']['userid'] > 0 AND $_SESSION['ilancedata']['user']['isstaff'] == '1')
{
	...
	$sql="SELECT *,DATE_ADD(scheduled_date, INTERVAL 5 DAY) as payment_due   FROM " . DB_PREFIX . "invoices WHERE date(scheduled_date) between '".$start_date."' and '".$end_date."'  and combine_project!='' and status='scheduled'";
