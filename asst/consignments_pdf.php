...
require_once('../fpdf.php'); 
		...
		$orderby = 'CatlogOrder';
		 $sqlcat_coin_detail=$ilance->db->query("select c.coin_id,c.Title,c.pcgs,c.Alternate_inventory_No,c.Certification_No,c.Minimum_bid,c.Buy_it_now 
		from 
		...
		SELECT coin_id,Title,pcgs,Alternate_inventory_No,Certification_No,Minimum_bid,Buy_it_now
