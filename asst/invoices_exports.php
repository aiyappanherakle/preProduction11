...
if (!empty($_SESSION['ilancedata']['user']['userid']) AND $_SESSION['ilancedata']['user']['userid'] > 0 AND $_SESSION['ilancedata']['user']['isstaff'] == '1')
{
	...
	$sql="SELECT CONCAT(u.first_name,' ',u.last_name) as user_name, u.first_name, u.last_name, u.address, u.address2, u.city, u.state,u.country, u.zip_code,u.email,i.invoiceid,i.combine_project,i.user_id,i.scheduled_date,i.totalamount,i.taxamount,i.istaxable,DATE_ADD(i.scheduled_date, INTERVAL 8 DAY) as payment_due   FROM " . DB_PREFIX . "invoices i 
...
$composed['LineClass']='';
	...
	$ilance->template->fetch('main', 'invoices_exports.html', 3);
